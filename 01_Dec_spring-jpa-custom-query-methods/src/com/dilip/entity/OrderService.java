...
public class OrderService {
	...
	public void getOrders() {
		...
		List<Orders> allOrders = repository.getOrdersInformation();
		for (Orders order : allOrders) {
			System.out.println(order);
		}
	}

	// with Postional Parameters
	public void getOrdersWithCityOrGender() {
		List<Orders> allOrders = repository.getDataWithCityOrGender("HYD", "FEMALE");
		for (Orders order : allOrders) {
			System.out.println(order);
		}
	...
	// with Names Postional Parameters
	public void ordersWithCityOrGender() {
		List<Orders> allOrders = repository.getOrdersWithCityOrGender("CHN", "MALE");
		for (Orders order : allOrders) {
			System.out.println(order);
		}
